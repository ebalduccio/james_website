...
const InterestsCards = () => {
    return (
        <div className="h-48 w-60 bg-stone-600 text-white font-roboto rounded-md"> {/* Reduced height and width */}
            ...
            <div className="flex flex-col items-center gap-3 "> {/* Adjusted gap */}
                <h1 className="text-2xl">Title</h1> {/* Smaller text */}
                <p className="text-xs text-center max-w-xs px-3"> {/* Adjusted padding and font size */}
